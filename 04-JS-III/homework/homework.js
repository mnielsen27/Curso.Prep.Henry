...
function cuentoElementos(arreglo) {
  ...
  //Escribe tu código aquí
  var i = 0;
  var ult = arreglo.length;
  var max = 0;
  for (i = 0; i < ult; i++) {
    if (arreglo[i] > 18) max = max + 1;
  }
  return max;
}
...
function mesesDelAño(array) {
  ...
  if (emn.length < 3) return "No se encontraron los meses pedidos";
  else return emn;
}
